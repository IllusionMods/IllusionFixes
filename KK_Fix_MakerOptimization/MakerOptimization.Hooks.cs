    ...
    public static class Hooks
    {
        public static void Patch(HarmonyInstance harmony)
        {
            SetupSetting(harmony,
                ...
                MakerOptimization.DisableNewIndicator);
            ...
            SetupSetting(harmony,
                ...
                MakerOptimization.DisableNewAnimation);

            if (MakerOptimization.DisableIKCalc.Value)
            {
        ...
        private static IEnumerator OnMakerLoaded()
        {
            ...
            if (MakerOptimization.DisableHiddenTabs.Value)
            {
